                ...
                <ul class="nav top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li>
                                <p class="green">You have 99+ pending tasks</p>
                            </li>
                            <li>
                                <a href="index.html#">
                                    <div class="task-info">
                                        <div class="desc">Book Selling</div>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered">Danny Bramantyo</h5>
                  ...
                  <li class="active">
                      <a href="<?=base_url('index.php/galery')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/pamphlet.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Galery</div></p>
                      </a>
                  </li>
                  <li class="active">
                      <a href="<?=base_url('index.php/event')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/event.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Event</div></p>
                      </a>
                  </li>
